...
class Texture(object):
    def __init__(self, textureData: TextureData):
        ...
        GL.glTexStorage2D(GL.GL_TEXTURE_2D, textureData.mipLevels, GL.GL_RGBA8, self.width, self.height)
        ...
        GL.glTexSubImage2D(GL.GL_TEXTURE_2D, 0, GL.GL_RGBA, self.width, self.height, 0, textureData.format, GL.GL_UNSIGNED_BYTE, numpy.asarray(textureData.data, dtype = numpy.uint8))
